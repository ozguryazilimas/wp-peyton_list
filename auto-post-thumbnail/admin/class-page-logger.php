...
use WBCR\Factory_Templates_134\ImpressiveLite;
...
class WAPT_Page_Logger extends WBCR\Factory_Templates_134\Pages\PageBase {
	...
	public function showRatingWidget( array $args ) {
		...
		$page_url = apply_filters( 'wbcr_factory_pages_480_implite_rating_widget_url', $page_url, $this->plugin->getPluginName(), $this->getResultId() );

		?>
		<div class="wbcr-factory-sidebar-widget">
			<p>
				<strong><?php esc_html_e( 'Do you want the plugin to improved and update?', 'wbcr_factory_templates_134' ); ?></strong>
			</p>
			<p><?php esc_html_e( 'Help the author, leave a review on wordpress.org. Thanks to feedback, I will know that the plugin is really useful to you and is needed.', 'wbcr_factory_templates_134' ); ?></p>
			<p><?php esc_html_e( 'And also write your ideas on how to extend or improve the plugin.', 'wbcr_factory_templates_134' ); ?></p>
			<p>
				<i class="wbcr-factory-icon-5stars"></i>
				<a href="<?php echo esc_url_raw( $page_url ); ?>" title="Go rate us" target="_blank">
					<strong><?php esc_html_e( 'Go rate us and push ideas', 'wbcr_factory_templates_134' ); ?></strong>
				</a>
			</p>
		</div>
		<?php
	...
	public function showSupportWidget() {
		...
		<div id="wbcr-clr-support-widget" class="wbcr-factory-sidebar-widget">
			<p><strong><?php esc_html_e( 'Having Issues?', 'wbcr_factory_templates_134' ); ?></strong></p>
			<div class="wbcr-clr-support-widget-body">
				<p>
					<?php esc_html_e( 'We provide free support for this plugin. If you are pushed with a problem, just create a new ticket. We will definitely help you!', 'wbcr_factory_templates_134' ); ?>
				</p>
				<ul>
					<li><span class="dashicons dashicons-sos"></span>
						<a href="<?php echo esc_url_raw( $free_support_url ); ?>" target="_blank"
						   rel="noopener"><?php esc_html_e( 'Get starting free support', 'wbcr_factory_templates_134' ); ?></a>
					</li>
					<li style="margin-top: 15px;background: #fff4f1;padding: 10px;color: #a58074;">
						<span class="dashicons dashicons-warning"></span>
						<?php printf( wp_kses_post( 'If you find a php error or a vulnerability in plugin, you can <a href="%s" target="_blank" rel="noopener">create ticket</a> in hot support that we responded instantly.', 'wbcr_factory_templates_134' ), esc_url_raw( $hot_support_url ) ); ?>
					</li>
				</ul>
			</div>
		</div>
