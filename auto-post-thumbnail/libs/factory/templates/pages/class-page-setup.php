 ...
 *
 * Этот класс унаследован от стандартного шаблона страницы \Wbcr_FactoryPages479_ImpressiveThemplate,
 ...
 *
 * @package WBCR\Factory_Templates_132\Pages
 * @author        Alex Kovalev <alex.kovalevv@gmail.com>, Github: https://github.com/alexkovalevv
 * @since         2.2.2
 */
class Setup extends \WBCR\Factory_Templates_132\Impressive {
	...
	public function __construct(\Wbcr_Factory479_Plugin $plugin)
	{
		...
		$this->menu_title = __('Setup master', 'wbcr_factory_templates_132');
		$this->page_menu_short_description = __('Setup master', 'wbcr_factory_templates_132');
		parent::__construct($plugin);
	}

	public function getPageTitle()
	{
		return __('Setup', 'wbcr_factory_templates_132');
	}
	...
	public function assets($scripts, $styles)
	{
		...
		$this->styles->add(FACTORY_TEMPLATES_132_URL . '/assets/css/page-setup.css');
	...
	{
		?>
		<div class="w-factory-templates-132-setup">
			<ol class="w-factory-templates-132-setup-steps">
			...
			<div class="w-factory-templates-132-setup-content">
				<?php echo $content; ?>
			</div>
			<a class="w-factory-templates-132-setup-footer-links" href="<?php echo esc_url($this->get_close_wizard_url()); ?>">
				<?php _e('Not now', 'wbcr_factory_templates_132') ?>
			</a>
		</div>
		<?php
	}
