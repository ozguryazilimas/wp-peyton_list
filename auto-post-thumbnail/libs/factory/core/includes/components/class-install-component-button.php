...
namespace WBCR\Factory_479\Components;
...
class Install_Button {
	 ...
	 * @since  4.3.3
	 */
	public function __construct(\Wbcr_Factory479_Plugin $plugin, $type, $plugin_slug)
	{
		...
		$this->add_data('i18n', \WBCR\Factory_Templates_132\Helpers::getEscapeJson($this->get_i18n()));
	...
	{
		return [
			'activate' => __('Activate', 'wbcr_factory_479'),
			'install' => __('Install', 'wbcr_factory_479'),
			'deactivate' => __('Deactivate', 'wbcr_factory_479'),
			'delete' => __('Delete', 'wbcr_factory_479'),
			'loading' => __('Please wait...', 'wbcr_factory_479'),
			'preparation' => __('Preparation...', 'wbcr_factory_479'),
			'read' => __('Read more', 'wbcr_factory_479')
		];
	}
