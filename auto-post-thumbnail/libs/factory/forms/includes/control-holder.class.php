<?php
	...
	if( !class_exists('Wbcr_FactoryForms479_ControlHolder') ) {
		/**
		 * The base class for control holders.
		 *
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms479_ControlHolder extends Wbcr_FactoryForms479_Control {
			 ...
			 *
			 * @since 1.0.0
			 * @return Wbcr_FactoryForms479_FormElement[].
			 */
