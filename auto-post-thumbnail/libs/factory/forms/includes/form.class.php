<?php
	...
	add_action('wbcr_factory_forms_479_plugin_created', 'wbcr_factory_forms_479_plugin_created');

	function wbcr_factory_forms_479_plugin_created($plugin)
	{
		$plugin->forms = new Wbcr_FactoryForms479_Manager($plugin);
	}

	if( !class_exists('Wbcr_FactoryForms479_Manager') ) {

		class Wbcr_FactoryForms479_Manager {
			 ...
			 *
			 * @see FactoryForms479_Form::registerControl()
			 *
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @see FactoryForms479_Form::registerHolder()
			 *
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @see FactoryForms479_Form::registerCustomElement()
			 *
			 * @since 1.0.0
			 * @return void
			 */
	...
	if( !class_exists('Wbcr_FactoryForms479_Form') ) {
		/**
		 * An abstraction for forms.
		 */
		class Wbcr_FactoryForms479_Form {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_IFactoryForms479_ValueProvider
			 */
			private $provider;
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms479_FormLayout
			 */
			public $layout;
			 ...
			 */
			public function __construct(array $options, Wbcr_Factory479_Plugin $plugin)
			{
				// register controls once, when the first form is created
				if( !Wbcr_FactoryForms479_Manager::$controls_registered ) {

					do_action('wbcr_factory_forms_479_register_controls', $plugin);

					//if( !empty($plugin) ) {
					do_action('wbcr_factory_forms_479_register_controls_' . $plugin->getPluginName(), $plugin);
					//}

					Wbcr_FactoryForms479_Manager::$controls_registered = true;
				}
				...
				Wbcr_FactoryForms479_Manager::$temper = 'flat';
			}
			 ...
			 *
			 * @since 1.0.0
			 * @param Wbcr_IFactoryForms479_ValueProvider $provider
			 * @return void
			 */
			...
			{
				return apply_filters('wbcr_factory_479_form_items', $this->items, $this->name);
			}
			 ...
			 *
			 * @since 1.0.0
			 * @return Wbcr_FactoryForms479_Control[]
			 */
			 ...
			 * @return Wbcr_FactoryForms479_FormElement|null A form element.
			 */
			 ...
			 * @return Wbcr_FactoryForms479_FormElement[] Created elements.
			 */
			 ...
			 * @since 1.0.0
			 * @param array $item Item data.
			 * @return Wbcr_FactoryForms479_Control A control object.
			 */
			public function createControl($item)
			{
				...
				if( is_array($item) ) {
					...
					$control_data = Wbcr_FactoryForms479_Manager::$registered_controls[$item['type']];
			 ...
			 * @since 1.0.0
			 * @param array $item Item data.
			 * @return Wbcr_FactoryForms479_Holder A control holder object.
			 */
			public function createHolder($item)
			{
				...
				if( is_array($item) ) {
					...
					$holderData = Wbcr_FactoryForms479_Manager::$registered_holders[$item['type']];
			 ...
			 * @return Wbcr_FactoryForms479_FormElement A custom form element object.
			 */
			public function createCustomElement($item)
			{
				...
				if( is_array($item) ) {
					...
					$data = Wbcr_FactoryForms479_Manager::$registered_custom_elements[$item['type']];
			...
			public function html($options = array())
			{
				...
				if( !isset(Wbcr_FactoryForms479_Manager::$form_layouts[$this->form_layout]) ) {
					die(sprintf('[ERROR] The form layout %s was not found.', $this->form_layout));
				}

				// include a render code
				$layout_data = Wbcr_FactoryForms479_Manager::$form_layouts[$this->form_layout];
			...
			public static function connectAssetsForItem($item)
			{
				...
				if( self::isControl($type) ) {
					$haystack = Wbcr_FactoryForms479_Manager::$registered_controls;
				} elseif( self::isControlHolder($type) ) {
					$haystack = Wbcr_FactoryForms479_Manager::$registered_holders;
				}
			...
			{
				return isset(Wbcr_FactoryForms479_Manager::$registered_controls[$item['type']]);
			}
			...
			{
				return isset(Wbcr_FactoryForms479_Manager::$registered_holders[$item['type']]);
			}
			...
			{
				return isset(Wbcr_FactoryForms479_Manager::$registered_custom_elements[$item['type']]);
			}
		}
	}