<?php
	...
	if( !class_exists('Wbcr_FactoryForms479_PaddingsEditorControl') ) {

		class Wbcr_FactoryForms479_PaddingsEditorControl extends Wbcr_FactoryForms479_Control {
				...
				<div <?php $this->attrs() ?>
					...
					<div class="factory-slider-container">
						<label class="factory-title">
							<?php _e('Select a side and move the slider to set up:', 'wbcr_factory_forms_479') ?>
						</label>
