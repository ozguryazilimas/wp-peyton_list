<?php
	...
	if( !class_exists('Wbcr_FactoryForms479_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms479_TabHolder extends Wbcr_FactoryForms479_Holder {
			 ...
			 * @param FactoryForms479_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms479_HtmlAttributeBuilder();
