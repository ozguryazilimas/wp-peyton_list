<?php
	...
	if( !class_exists('Wbcr_FactoryForms479_MultipleTextboxControl') ) {

		class Wbcr_FactoryForms479_MultipleTextboxControl extends Wbcr_FactoryForms479_Control {
			...
			public function html()
			{
				...
				<div class="factory-multiple-textbox-group">
					...
					<button class="btn btn-default btn-small factory-mtextbox-add-item">
						<i class="fa fa-plus" aria-hidden="true"></i> <?php _e('Add new', 'wbcr_factory_forms_479') ?>
					</button>
				</div>
