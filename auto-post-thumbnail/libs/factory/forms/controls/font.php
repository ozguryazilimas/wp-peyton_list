<?php
	...
	if( !class_exists('Wbcr_FactoryForms479_FontControl') ) {

		class Wbcr_FactoryForms479_FontControl extends Wbcr_FactoryForms479_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->size = new Wbcr_FactoryForms479_IntegerControl($option_font_size, $form, $provider);
				$this->family = new Wbcr_FactoryForms479_DropdownControl($option_font_family, $form, $provider);
				$this->color = new Wbcr_FactoryForms479_ColorControl($optionFontColor, $form, $provider);
			...
			public function getFonts()
			{
				...
				$fonts = apply_filters('wbcr_factory_forms_479_fonts', $fonts);
				$fonts = apply_filters('wbcr_factory_forms_479_fonts-' . $this->options['name'], $fonts);
			...
			public function getDefaultFonts()
			{
				...
				$fonts = array(
					...
					array('inherit', __('(use default website font)', 'wbcr_factory_forms_479')),
					array(
						'group',
						__('Sans Serif:', 'wbcr_factory_forms_479'),
						array(
					...
					array(
						'group',
						__('Serif:', 'wbcr_factory_forms_479'),
						array(
							array(
					...
					array(
						'group',
						__('Monospaced:', 'wbcr_factory_forms_479'),
						array(
