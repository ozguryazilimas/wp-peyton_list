<?php
	...
	if( !class_exists('Wbcr_FactoryForms479_DatepickerRangeControl') ) {

		class Wbcr_FactoryForms479_DatepickerRangeControl extends Wbcr_FactoryForms479_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->range_1 = new Wbcr_FactoryForms479_TextboxControl($options['range_1'], $form, $provider);
				$this->range_2 = new Wbcr_FactoryForms479_TextboxControl($options['range_2'], $form, $provider);
