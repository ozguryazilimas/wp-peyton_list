<?php
	 ...
	 *  // see FactoryForms479_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms479_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms479_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms479_DropdownAndColorsControl extends Wbcr_FactoryForms479_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms479_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms479_RadioColorsControl($options['colors'], $form, $provider);
