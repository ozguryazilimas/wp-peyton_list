<?php
	...
	if( !class_exists('Wbcr_FactoryForms479_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms479_Bootstrap3FormLayout extends Wbcr_FactoryForms479_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms479_Control $control
			 */
